--[[ packages/jumbalaya_core/cards/letter_modifiers.lua - Per-letter modifier data (no G) ]]
...
M.LETTER_MODIFIERS = {
	...
	C = modifier_entry("2× if another C played.", "+2× combo"),
	D = modifier_entry("2x if ends with.", "+1 point"),
	E = modifier_entry("Gives +1 point.", "+1 point"),
	F = modifier_entry("Gain +2 points.", "+2 points"),
	...
	J = modifier_entry("Attaches U, creating JU", "+U attached"),
	K = modifier_entry("Gives +0.2× multiplier.", "+0.2×"),
	L = modifier_entry("Adds +4 points for 4+ letter word.", "+4 points"),
