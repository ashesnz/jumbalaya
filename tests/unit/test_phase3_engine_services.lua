...
T.describe("Phase 3 Engine Service Interfaces", function()
	...
	T.it("builds EngineContext and binds at boot", function()
		...
		T.assert_not_nil(G._engine)
		T.assert_not_nil(G._engine.renderer)
		T.assert_not_nil(G._engine.input)
		T.assert_not_nil(G._engine.audio)
		T.assert_not_nil(G._engine.clock)
		T.assert_equal(G._engine.store, G._store)
	end)
end)
