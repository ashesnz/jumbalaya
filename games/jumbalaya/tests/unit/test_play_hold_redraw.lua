...
T.describe("Play Button Hold Redraw (word_game.ui.table.controls.play_hold_redraw)", function()
	mock_env.reset_game()
	local PlayHoldRedraw = require("word_game.ui.table.controls.play_hold_redraw")
	...
	T.it("can_hold respects game state and active animations", function()
		...
		WORD_GAME = WORD_GAME or {}
		WORD_GAME_UI.TableControls = WORD_GAME_UI.TableControls or {}
		WORD_GAME_UI.TableControls.play_button_uie = function() return mock_btn end
		WORD_GAME_UI.TradeUI = { is_open = function() return false end }
	...
	T.it("tracks hold state and triggers redraw at 5 seconds", function()
		...
		WORD_GAME_UI.TableControls = WORD_GAME_UI.TableControls or {}
		WORD_GAME_UI.TableControls.play_button_uie = function() return mock_btn end
		WORD_GAME_UI.TableControls.sync = function() return true end
