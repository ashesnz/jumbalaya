--[[ word_game/config/gameplay/round.lua - Set / hand targets and play limits ]]

local M = {
	-- Voucher discard allowance per hand (drag onto discard_bin perk imprint).
