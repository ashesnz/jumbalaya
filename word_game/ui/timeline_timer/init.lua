--[[
	word_game/ui/timeline_timer/init.lua - Timeline HUD (timer fuse or classic score slider).
...
local timer_layout = require("word_game.ui.timeline_timer.layout")
local timer_draw = require("word_game.ui.timeline_timer.draw")
