...
| **Boot / policy** | `test_boot_simulation.lua`, `test_g_funcs_registry.lua`, `test_store_state_catalog.lua`, `test_facade_boundaries.lua` | Startup smoke, Funcs catalog, run-state catalog, facade imports |
